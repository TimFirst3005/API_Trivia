...
def create_app(test_config=None):
  ...
  def get_question():
    ...
    return jsonify({
      ...
      'number number of total questions': len(questions),
  ...
  def search_question():
    ...
    return jsonify({
      'success': True,
      'questions': current_questions,
      'total_questions_find': len(current_questions),
  ...
  def quiz(category_id):
    ...
    question_id = random.randint(1, l)

    if question_id in questions.format().id:
      previous_question_id.append(question_id)
